...
import { idlFactory } from './konkursss_frontend.did.js';
export { idlFactory } from './konkursss_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_KONKURSSS_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./konkursss_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the konkursss_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./konkursss_frontend.did.js")._SERVICE>}
 */
export const konkursss_frontend = createActor(canisterId);
