...
import { idlFactory } from './konkursss_backend.did.js';
export { idlFactory } from './konkursss_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_KONKURSSS_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./konkursss_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the konkursss_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./konkursss_backend.did.js")._SERVICE>}
 */
export const konkursss_backend = createActor(canisterId);
